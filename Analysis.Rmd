...
# Discussion
The first boxplot displayed the weight of small mammals at all NEON sites. The average weight is showcased on a scale from 0 to 450 grams. The average weight for each site varies as some sites have showcase no small mammal weight above 50 grams such as the "DEJU" and "HEAL" site while other sites visibly surpass 400 grams such as the "CLBJ" site and "LAJA" site.
