...
The second boxplot models the highest average small mammal weight by looking at the weight of small mammal species at the "CLBJ" NEON site. This site displays the weight of 9 different species with varying weights. The two species that had noticeably high weights were *Neotoma micropus* and *Sigmodon hispidus*, both these species weights were above 100 grams while the other 7 species weights were not as variable and under 50 grams. *Sigmodon hispidus* is a hispid cotton rat while *Neotoma micropus* is a southern plains wood rat. Both these species are rather common in the Southern Plains of Texas. It has been studied that these two species of rats are common in the Southern Plains of Texas when abundance of grass cover was deeper and that the common denominator of cotton rat habitat was tall, dense grass with various forbs and shrubs [@green2014habitat]. Species that were less variable and found to be under 50 grams like the *Chaetodipus hispidus* pocket mice, for example, are typically common in areas of intermediate cover, in places like Arizona, as they are seen increased in areas of grazed plot and seen declined in areas of ungrazed plot since they are much smaller rats and ungrazed plots are dominated by taller species [@jones2003rodent]. 

The third boxplot models the lowest average small mammal weight by looking at the weigh tof small mammal species at the "SERC" site. Unlike the "CLBJ" site there are only 6 visible species weights at this site and all 6 species have relatively constant weights. The weight scale is from 0 to 30 grams, with no outliers for any of the species with the exception of 2 single outliers for *Peromyscus leucopus*.  
