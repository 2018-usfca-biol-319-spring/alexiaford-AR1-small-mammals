...
# make a scatterplot for the weight of small mammals at "CBJL" NEON site
plot(x = as.POSIXct(mam_pertrapnight$collectDate),
    y = weight_data$dryMass,
    main = "Weight of Small Mammals at LBJ National Grassland",
    xlab = "Date",
...
plot(x = as.POSIXct(mam_pertrapnight$collectDate),
    y = weight_data$dryMass,
    main = "Weight of Small Mammals at Smithsonian Environmental Research Center",
    xlab = "Date",
    ylab = "Weight in grams",
    pch = 16)
```
